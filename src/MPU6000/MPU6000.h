...
#define MPU6000_RA_SELF_TEST_X      0x0D //[7:5] XA_TEST[4-2], [4:0] XG_TEST[4-0]
#define MPU6000_RA_SELF_TEST_Y      0x0E //[7:5] YA_TEST[4-2], [4:0] YG_TEST[4-0]
#define MPU6000_RA_SELF_TEST_Z      0x0F //[7:5] ZA_TEST[4-2], [4:0] ZG_TEST[4-0]
#define MPU6000_RA_SELF_TEST_A      0x10 //[5:4] XA_TEST[1-0], [3:2] YA_TEST[1-0], [1:0] ZA_TEST[1-0]
...
#define MPU6000_SELF_TEST_XA_1_BIT     0x07
#define MPU6000_SELF_TEST_XA_1_LENGTH  0x03
#define MPU6000_SELF_TEST_XA_2_BIT     0x05
#define MPU6000_SELF_TEST_XA_2_LENGTH  0x02
#define MPU6000_SELF_TEST_YA_1_BIT     0x07
#define MPU6000_SELF_TEST_YA_1_LENGTH  0x03
#define MPU6000_SELF_TEST_YA_2_BIT     0x03
#define MPU6000_SELF_TEST_YA_2_LENGTH  0x02
#define MPU6000_SELF_TEST_ZA_1_BIT     0x07
#define MPU6000_SELF_TEST_ZA_1_LENGTH  0x03
#define MPU6000_SELF_TEST_ZA_2_BIT     0x01
#define MPU6000_SELF_TEST_ZA_2_LENGTH  0x02

#define MPU6000_SELF_TEST_XG_1_BIT     0x04
#define MPU6000_SELF_TEST_XG_1_LENGTH  0x05
#define MPU6000_SELF_TEST_YG_1_BIT     0x04
#define MPU6000_SELF_TEST_YG_1_LENGTH  0x05
#define MPU6000_SELF_TEST_ZG_1_BIT     0x04
#define MPU6000_SELF_TEST_ZG_1_LENGTH  0x05
...
class MPU6000
{
  public:
    ...
    void initialize(PinName pinCS, uint32_t spiLS, uint32_t spiHS, spi_stm32_mode_e mode, spi_stm32_bitorder_e msb);
    bool testConnection();

    void fullDeviceReset();
    void setSpeedSPI(uint32_t ulVal);
